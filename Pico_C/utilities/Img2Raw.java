    ...
    public static void main(String[] args) throws IOException {
        ...
        if (print8) {
            for (Integer c : buf) {
                ...
                for (int t = 0; t < 3; ++t) {
                    temp = String.format("0x%x,", (c >> (t * 8)) & 0xff).toCharArray();
                    for (char ch : temp)
                        w.writeByte(ch);
                    num++;
                }
            ...
            for (int c : buf) {
                ...
                num++;
                nl++;
                temp = String.format("%s, ", Integer.toHexString(to565(c & 0xffffff))).toCharArray();
                for (char ch : temp)
                    w.writeByte(ch);
